...
users = [  # Список користувачів з їхніми датами народження
    ...
    {"name": "Emily Way", "birthday": "1990.01.27"},
    {"name": "Richard Esom", "birthday": "1990.03.05"},
    {"name": "David Jackson", "birthday": "1990.03.07"},
...
def upcoming_birthdays(users, days):  # Функція для перевірки на наближені дні народження
